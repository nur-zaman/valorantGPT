...
def main():
    ...
    for _provider in providers:
        if _provider.__name__=='ChatgptLogin':
            continue
        ...
        if _provider.working and not result:
            ...
            working_provider.append(_provider)
    ...
    if failed_providers:
        ...
        print(f"{Fore.GREEN}Working providers:\n")
        for _provider in working_provider:
            print(f"{Fore.GREEN}{_provider.__name__}")
    else:
